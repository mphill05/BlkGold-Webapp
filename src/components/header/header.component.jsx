...
import { faApple, faBandcamp, faDiscord, faFacebook, faInstagram, faSoundcloud, faSpotify, faTwitch, faTwitter } from '@fortawesome/free-brands-svg-icons';
...
function Header() {
    ...
    return (
        <Navbar expand='lg' className='color-nav' variant='dark' fixed='top'>
            <Navbar.Brand onClick={Navbar.Toggle}>
            ...
            <Navbar.Collapse className='justify-content-end' onClick={Navbar.Toggle}>
